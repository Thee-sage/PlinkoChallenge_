          ...
          <div className={styles.navContainer}>
            <div className={styles.navContent}>
              <div className={styles.navLinks}>
                <Link to="/admin/game-settings" className={styles.navLink}>
                  Game Settings
                </Link>
                <Link to="/admin/wallet-requests" className={styles.navLink}>
                  Wallet Requests
                </Link>
                <Link to="/admin/ads" className={styles.navLink}>
                  Manage Ads
                </Link>
                <Link to="/admin/casinos" className={styles.navLink}>
                  Manage Casinos
                </Link>
              </div>
