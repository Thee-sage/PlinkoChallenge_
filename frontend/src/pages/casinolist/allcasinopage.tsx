...
export function PublicCasinoList(): JSX.Element {
  ...
  const casinoRefs = useRef<{ [key: string]: HTMLDivElement | null }>({});
  useEffect(() => {
  ...
  useEffect(() => {
    // Check if there's a casino ID in the hash
    const casinoId = location.hash.replace('#', '');
    if (casinoId && casinoRefs.current[casinoId]) {
      // Wait a bit for the page to fully render
      setTimeout(() => {
        casinoRefs.current[casinoId]?.scrollIntoView({
          behavior: 'smooth',
          block: 'center'
        });
      }, 100);
    }
  }, [location.hash, casinos]);
  if (isLoading) {
  ...
  return (
    ...
    <div className={styles.samagriContainer}>
      ...
      {casinos.map((casino: Casino) => (
        <div 
          key={casino._id} 
          className={styles.casinoWrapper}
          ref={el => casinoRefs.current[casino._id] = el}
          id={casino._id}
        >
              ...
              <div className={styles.contentContainer}>
                  ...
                  <div className={styles.card}>
                      ...
                      <div id="overview" className={styles.header}>
                          <div className={styles.headerContent}>
                              ...
                              <div className={styles.ratingTrust}>
                                  ...
                                  <span className={`${styles.trustBadge} ${casino.trustIndex === 'High' ? styles.trustHigh : casino.trustIndex === 'Medium' ? styles.trustMedium : styles.trustLow}`}>
                                      {casino.trustIndex} Trust
                                  </span>
                              </div>
                      ...
                      <div className={styles.contentWrapper}>
                          ...
                          <div id="terms" className={styles.termsSection}>
                          ...
                          <div id="payments" className={styles.paymentsSection}>
                          ...
                          <div id="banking" className={styles.bankingSection}>
                          ...
                          <div id="security" className={styles.securitySection}>
                          ...
                          <div id="pros-cons" className={styles.prosConsSection}>
...
{casino.contentSections.length > 0 && (
    <div id="additional-info" className={styles.contentSection}>
