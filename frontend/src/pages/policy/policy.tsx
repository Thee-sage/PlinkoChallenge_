    ...
    <div className={styles.policyContainer}>
      ...
      <div className={styles.policyContent}>
        ...
        <section id="introduction" className={styles.section}>
          <h2>Introduction</h2>
          <p>This Privacy Policy explains how plinkoChallenge.com ("we," "us," or "our") collects, uses, and protects your information when you use our website.</p>
        </section>
        ...
        <section id="terms" className={styles.section}>
          ...
          <div className={styles.subsection}>
            <h3>Limitations</h3>
            <p> plinkoChallenge.com will not be liable for any damages arising from the use or inability to use our service. This includes but is not limited to:</p>
            <ul>
        ...
        <section id="contact" className={styles.section}>
          ...
          <div className={styles.subsection}>
            ...
            <ul>
              <li>Email: info@plinkoChallenge.com</li>
            </ul>
